...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveRequest(Integer userId, ItemRequestCreateDto itemRequestCreateDto) {
    ...
    public ResponseEntity<Object> getAlienRequests(Integer userId, Integer from, Integer size) {
